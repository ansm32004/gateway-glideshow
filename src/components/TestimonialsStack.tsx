      ...
      <div className="container mx-auto px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {testimonials.map((testimonial, index) => (
            <div
              key={index}
              className={`relative bg-card rounded-3xl p-8 shadow-lg hover:shadow-2xl transition-all duration-500 card-stack slide-up stagger-${(index % 3) + 1} border border-border/50 hover:border-primary/20 group`}
            >
              <div className="mb-6">
